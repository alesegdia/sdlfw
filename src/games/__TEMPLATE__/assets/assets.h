...
public:
	...
	assets (SDL_Renderer* renderer) {
		...
		textures[SF_SCROLLBG] = new Texture(renderer,"media/frog/0CaveBack2.png");
		textures[SF_ROCK1] = new Texture(renderer,"media/frog/mushrock0.png");
		textures[SF_ROCK2] = new Texture(renderer,"media/frog/mushRock1.png");
		textures[SF_ROCK3] = new Texture(renderer,"media/frog/mushRock2.png");
	...
	static const size_t SF_SCROLLBG = 8;
	static const size_t SF_ROCK1 = 9;
	static const size_t SF_ROCK2 = 10;
	static const size_t SF_ROCK3 = 11;
